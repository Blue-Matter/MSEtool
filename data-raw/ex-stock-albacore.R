...
NaturalMortality(AlbacoreExStock) <- NaturalMortality(
  Pars = list(M = c(0.35, 0.45))
)

## ---- albacore-create-maturity ----
Maturity(AlbacoreExStock) <- Maturity(
  Pars = list(L50    = c(81, 91),
              L50_95 = c(10, 12))
)
