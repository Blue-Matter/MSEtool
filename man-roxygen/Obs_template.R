...
#'  error distribution with a mean of 1 and a standard deviation equal to the CV.
#'  The yearly observation error values for the catch data are then drawn from this
#'  distribution. For each time step the simulation model records the true catch,
#'  but the observed catch is generated by applying this yearly error term (plus
#'  any bias, if specified) to the true catch.
...
#'  with a mean of 1. For each simulation a bias value is drawn from this
#'  distribution, and that bias is applied across all years.
...
#'  mean of 1 and a standard deviation equal to the CV. The yearly observation
#'  error values for the index of abundance data are then drawn from this
#'  distribution. For each time step the simulation model records the true change
#'  in abundance, but the observed index is generated by applying this yearly error
#'  term (plus any bias, if specified) to the true relative change in abundance.
...
#'  distribution. Each CV is used to specify a log-normal error distribution with a
#'  mean of 1 and a standard deviation equal to the CV. The yearly observation
#'  error values for the absolute abundance data are then drawn from this
...
#'  log-normal distribution with a mean of 1. For each simulation a bias value is
...
#'  distribution with a mean of 1. For each simulation a bias value is drawn from
#'  this distribution, and that bias is applied across all years. Positive real
#'  numbers.
...
#'  deviation of a log-normal distribution with a mean of 1. For each simulation a
#'  bias value is drawn from this distribution, and that bias is applied across all
...
#'  standard deviation of a log-normal distribution with a mean of 1. For each
#'  simulation a bias value is drawn from this distribution, and that bias is
#'  applied across all years. Positive real numbers.
...
#'  specifying the standard deviation of a log-normal distribution with a mean of
#'  1. For each simulation a bias value is drawn from this distribution, and that
#'  bias is applied across all years. Positive real numbers.
...
#'  with a mean of 1 and a standard deviation equal to the CV. The yearly
...
#'  of a log-normal distribution with a mean of 1. For each simulation a bias value
#'  is drawn from this distribution, and that bias is applied across all years.
#'  Positive real numbers.
...
#'  bounds of a uniform distribution, and for each simulation a CV is sampled from
#'  this distribution. Each CV is used to specify a log-normal error distribution
#'  with a mean of 1 and a standard deviation equal to the CV. The yearly bias
#'  values for the depletion data are then drawn from this distribution. Positive
#'  real numbers.
...
#'  is sampled from this distribution. Each CV is used to specify a log-normal
#'  error distribution with a mean of 1 and a standard deviation equal to the CV.
#'  The yearly observation error values for the effort data are then drawn from
#'  this distribution. For each time step the simulation model records the true
#'  effort, but the observed effort is generated by applying this yearly error term
#'  (plus any bias, if specified) to the true effort.
