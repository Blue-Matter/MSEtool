...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(CalcFisheryDynamics_(HistIn, Years, AllYears, Sims, nSim, nStock, nFleet, nArea, DoCalcCatch, DoCalcSpawnProduction, DoCalcRecruitment, DoCalcNumberNext, DoCalcBiomass, DoCalcOverallF, debug, clone));
    return rcpp_result_gen;
END_RCPP
}
// combine
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_MSEtool_CalcFisheryDynamics_", (DL_FUNC) &_MSEtool_CalcFisheryDynamics_, 16},
