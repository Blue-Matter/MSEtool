...
#'
#' Standard logistic maturity models using the 50/95 parameterization.
#'
#'
...
#' @param A50_95 age at 95% maturity (Logistic-at-Age)
#' @param L50 length at 50% maturity (Logistic-at-Length)
#' @param L50_95 length at 95% maturity (Logistic-at-Length)
#' @param W50 weight at 50% maturity (Logistic-at-Weight)
#' @param W50_95 weight at 95% maturity (Logistic-at-Weight)
...
logistic_50_95 <- function(x, x50, x50_95) {
  slope <- log(19) / (x50_95 - x50)
  1 / (1 + exp(-slope * (x - x50)))
}
