...
# # }
# 
# CalcMSYRefPoints <- function(Hist, RefPointYears, RefPointsMSY=TRUE) {
# 
...
# 
# 
# CalculateMSYSim <- function(x, OM, Years=NULL) {
#   
#   if (is.null(Years))
#     Years <- OM@Years
#   
#   logApicalFRange <- log(c(1E-5, OM@maxF))
#   
#   Complexes <- OM@Complexes
#   
...
# 
# 
# OptMSY <- function(logApicalF, OM, Years, option=1) {
# 
