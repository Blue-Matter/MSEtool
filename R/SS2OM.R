...
#' @param interval The interval at which management procedures will update the management advice in \link[MSEtool]{runMSE}, e.g., 1 = annual updates.
...
#' @param report Logical, if TRUE, the function will run \link[MSEtool]{runMSE} to generate historical data from the operating model
