...
methods::setClassUnion(name="char.log.num", members=c("character", "logical", 'numeric'))
...
methods::setClassUnion(name="array.char.num", members=c("array", 'character', 'numeric', 'list',  "NULL"))
