...
SimulateMOM_DEVVERSION <- function(MOM=MSEtool::Albacore_TwoFleet, parallel=TRUE, silent=FALSE) {
...
ProjectMOM_DEVVERSION <- function (multiHist=NULL, MPs=NA, parallel=FALSE, silent=FALSE,
...
multiMSE_DEVVERSION <- function(MOM=MSEtool::Albacore_TwoFleet,
