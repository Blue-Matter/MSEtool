...
#'   generated by `r4ss`. 
#' @param Hist A `hist-class` or an `om-class` object.
#' @param sim Simulation number. Default 1
#' 
CompareSS <- function(SSDir, Hist, sim=1, thresh=0.1, silent=FALSE) {
...
CompareSS_Number <- function(RepList, Hist, sim=1) {
  ...
  OM_Value <- Number(Hist, df=TRUE) |> dplyr::mutate(Model='OM') |>
